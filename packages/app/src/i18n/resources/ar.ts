...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          mergePrDirty: "دمج PR غير متاح أثناء وجود تغييرات محلية، أودعها وادفعها أولاً",
          mergePrUnpushed: "دمج PR غير متاح حتى يتم دفع الإيداعات المحلية",
      ...
      diff: {
        ...
        searchBranches: "ابحث في الفروع...",
        loadingBranches: "جارٍ تحميل الفروع…",
        noBranches: "لا توجد فروع مطابقة",
        failedSetTargetBranch: "تعذّر تغيير الفرع الهدف.",
        branchUnknown: "مجهول",
        base: "قاعدة",
        newFile: "جديد",
      ...
      prFlow: {
        ...
        copyLink: "نسخ الرابط",
        blocked: {
          checksFailed: "أصلح الفحوصات الفاشلة قبل الدمج",
          checksRunning: "لا تزال الفحوصات قيد التشغيل",
          changesRequested: "طلب أحد المراجعين تغييرات",
          reviewRequired: "المراجعة مطلوبة قبل الدمج",
        },
        continue: "متابعة",
        continueTooltip: "المتابعة على فرع جديد بنفس المحادثات",
        archive: "أرشفة",
        merge: "دمج",
        mergeOptions: "خيارات الدمج",
        resolve: "حل التعارضات",
        fix: "إصلاح الفحوصات",
  ...
  newWorkspace: {
    ...
    createFrom: {
      ...
      noBranches: "لا توجد فروع مطابقة",
      noIssues: "لا توجد مشكلات مطابقة",
      targetBranch: "الفرع الهدف",
    },
