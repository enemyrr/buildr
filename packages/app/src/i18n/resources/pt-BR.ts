...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        failedSetTargetBranch: "Falha ao alterar o branch de destino.",
      ...
      prFlow: {
        ...
        archive: "Arquivar",
        merge: "Mesclar",
        mergeOptions: "Opções de mesclagem",
        resolve: "Resolver conflitos",
        ...
        changes: {
          ...
          noMatchingFiles: "Nenhum arquivo corresponde a este filtro.",
  ...
  sidebar: {
    ...
    resources: {
      unavailableProviders: "Provedores indisponíveis ({{count}})",
      trigger: "Uso",
      title: "Recursos",
      cpu: "CPU",
      memory: "Memória",
  ...
  newWorkspace: {
    ...
    createFrom: {
      ...
      noBranches: "Nenhum branch correspondente",
      noIssues: "Nenhuma issue correspondente",
      targetBranch: "Branch de destino",
    },
