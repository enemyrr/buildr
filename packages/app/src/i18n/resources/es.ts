...
export const es: TranslationResources = {
  ...
  dashboard: {
    ...
    more: "Más",
    emptyColumn: "Sin espacios de trabajo",
    columns: {
      backlog: "Pendiente",
      inProgress: "En curso",
    ...
    actions: {
      ...
      resetStatus: "Usar estado del PR",
    },
  },
  sessions: {
    filters: {
      allProjects: "En todos los proyectos",
      inProject: "En {{project}}",
      hidingArchived: "Ocultando archivados",
  ...
  workspace: {
    ...
    tabs: {
      ...
      newChat: {
        ...
        addTranscripts: "Añadir transcripciones de chats:",
        more: "+{{count}} más",
        attachFailed: "No se pudo adjuntar la transcripción",
      },
      loading: "Cargando...",
      ...
      toasts: {
        ...
        transcriptCopiedLabel: "Transcripción",
    ...
    utilityPanel: {
      ...
      runEmptyTitle: "Añadir script de ejecución",
      setupEmptyTitle: "Añadir script de configuración",
      setupEmptyDescription:
        "Ejecuta comandos al crear un espacio de trabajo para instalar dependencias o preparar el entorno",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajo Buildr",
          mergePrNoForge:
      ...
      diff: {
        ...
        noBranches: "No hay ramas coincidentes",
        failedSetTargetBranch: "No se pudo cambiar la rama de destino.",
      ...
      prFlow: {
        createPr: "Crear PR",
        createDraftPr: "Crear PR en borrador",
        createPrDirectly: "Crear PR directamente",
        createPrManually: "Crear PR manualmente",
        options: "Opciones de PR",
        review: "Revisar",
        ...
        fix: "Corregir comprobaciones",
        autoMerge: "Fusión automática",
        state: {
          readyToMerge: "Listo para fusionar",
          open: "Abierto",
          draft: "Borrador",
          merged: "Fusionado",
          closed: "Cerrado",
          conflicts: "Conflictos de fusión",
          checksFailed: "Comprobaciones fallidas",
          checksRunning: "Comprobaciones en curso",
          autoMergeEnabled: "Fusión automática activada",
        ...
        changes: {
          ...
          showAsTree: "Mostrar como árbol",
          showAsList: "Mostrar como lista",
          filterFiles: "Filtrar archivos",
          filteredFiles: "{{visible}} de {{total}}",
          noMatchingFiles: "Ningún archivo coincide con este filtro.",
          clearFilter: "Borrar filtro",
        },
        checks: {
          titlePlaceholder: "Título del PR",
          descriptionPlaceholder: "Descripción del PR",
          gitStatus: "Estado de Git",
          noPr: "No hay PR abierto",
          prOpen: "PR {{ref}} abierto",
          prDraft: "PR en borrador {{ref}} abierto",
          prMerged: "PR {{ref}} fusionado",
          prClosed: "PR {{ref}} cerrado",
  ...
  sidebar: {
    ...
    resources: {
      unavailableProviders: "Proveedores no disponibles ({{count}})",
      trigger: "Uso",
      title: "Recursos",
      cpu: "CPU",
      memory: "Memoria",
      ...
      context: "Contexto",
      noContext: "Ningún agente abierto informa aún su contexto.",
  ...
  newWorkspace: {
    promptPlaceholder: "¿En qué quieres trabajar?",
    moreOptions: "Más opciones",
    createFrom: {
      title: "Crear desde",
      searchPlaceholder: "Buscar pull requests y ramas",
      pullRequests: "PRs",
      branches: "Ramas",
      issues: "Issues",
      noPullRequests: "No hay pull requests coincidentes",
      noBranches: "No hay ramas coincidentes",
      noIssues: "No hay issues que coincidan",
      targetBranch: "Rama de destino",
    },
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje que Buildr inicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, pero Buildr no pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales de Buildr",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónIntelde Buildr enRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificación Buildr",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar el Buildr CLI.",
      },
    },
  },
  rootError: {
    title: "Buildr tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidor Buildr.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de Buildr en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Buildr",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Buildr Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRcon Buildr en su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  panels: {
    ...
    file: {
      ...
      missing: "Este archivo aún no existe",
  ...
  settings: {
    search: {
      ...
      clear: "Borrar búsqueda de ajustes",
    ...
    notifications: {
      ...
      sentDescription: "Buildr entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que Buildr usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "Buildr elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa Buildr",
      model: "Modelo",
      fallbackHint: "Si no está disponible, Buildr usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en Buildr.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualiza Buildr en esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades de Buildr?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidades Buildr?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestación Buildr de ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientas Buildr",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientas Buildr",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado. Buildr se vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio. Buildr se vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por Buildr Desktop. Actualiza Buildr Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Buildr supervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA que Buildr utiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
