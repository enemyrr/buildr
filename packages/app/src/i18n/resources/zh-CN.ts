    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          mergePrDirty: "存在本地更改时无法合并 PR，请先提交并推送",
          mergePrUnpushed: "推送本地提交后才能合并 PR",
      ...
      diff: {
        ...
        noBranches: "没有匹配的分支",
        failedSetTargetBranch: "无法更改目标分支。",
        branchUnknown: "未知",
        base: "base",
        newFile: "新增",
        deletedFile: "已删除",
      ...
      prFlow: {
        ...
        copyLink: "复制链接",
        blocked: {
          checksFailed: "请在合并前修复失败的检查",
          checksRunning: "检查仍在运行",
          changesRequested: "审查者请求了更改",
          reviewRequired: "合并前需要审查",
        },
        continue: "继续",
  ...
  settings: {
    ...
    project: {
      ...
      git: {
        ...
        archiveOnMergeHint: "拉取请求合并后归档该工作区",
        archiveOnMergeHost: "主机默认",
        archiveOnMergeOn: "开启",
        archiveOnMergeOff: "关闭",
      },
      scripts: {
        title: "Scripts",
