export const en = {
  ...
  composer: {
    loadout: {
      ...
      fast: "Fast",
      edit: "Edit",
      editLabel: "Edit default models",
      cycleEffort: "Cycle effort",
      addModels: "Add models…",
      moreModels: "More models…",
      reorder: "Reorder {{model}}",
      selectWithValue: "Select model ({{model}})",
      unavailable: "{{model}} runs on another provider",
      shortcuts: {
        modelSlot: "Switch to model 1-5",
        cycleEffort: "Cycle effort",
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        failedSetTargetBranch: "Failed to change the target branch.",
  ...
  sidebar: {
    ...
    resources: {
      ...
      showLess: "Show less",
      context: "Context",
      noContext: "No open agents report context usage yet.",
  ...
  modelSelector: {
    ...
    profiles: "Presets",
    editProfiles: "Edit",
    editProfilesLabel: "Edit model presets",
    createProfile: "Save preset",
    createProfileFromModel: "Save this model as a preset",
  ...
  settings: {
    ...
    defaultModels: {
      ...
      catalogTitle: "Models",
      catalogInfo: "Select a model to add it to the loadout or remove it.",
      defaultBadge: "Default",
      dropHint: "Drop model here",
      emptySlot: "Empty",
      remove: "Remove {{name}} from the loadout",
      effortLabel: "Thinking level for {{name}}: {{value}}",
      effortDefault: "Default",
      full: "The loadout is full",
      configure: "Configure {{provider}}",
      loading: "Loading models...",
      unavailable: "Connect to this host to choose default models",
      unsupported: "Update the host to choose default models",
    },
    plugins: {
      title: "Plugins",
      screens: {
    ...
    host: {
      ...
      agentProfiles: {
        sectionTitle: "Model presets",
        unavailable: "Connect to this host to manage model presets",
        unsupported: "This host runs a daemon that does not support model presets yet",
        emptyState: "No presets yet. Add one to start agents from a saved provider and model.",
        addProfileTitle: "Add model preset",
        newProfile: "New preset",
        editProfile: "Edit preset",
        editProfileTitle: "Edit model preset",
        nameLabel: "Name",
        ...
        notesHint: "Helps agents choose this preset when starting another agent.",
        save: "Save",
        saving: "Saving...",
        remove: "Remove",
        removeConfirmTitle: "Remove preset?",
        removeConfirmMessage: 'Remove "{{name}}"?',
        moveUp: "Move up",
        moveDown: "Move down",
      },
