...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        failedSetTargetBranch: "Impossible de changer la branche cible.",
  ...
  sidebar: {
    ...
    project: {
      ...
      archived: {
        title: "Espaces de travail archivés",
        empty: "Aucun espace de travail archivé",
        loadFailed: "Impossible de charger les espaces de travail archivés",
      },
      confirmations: {
  ...
  newWorkspace: {
    ...
    createFrom: {
      ...
      noBranches: "Aucune branche correspondante",
      noIssues: "Aucune issue correspondante",
      targetBranch: "Branche cible",
    },
