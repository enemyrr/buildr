...
const SHORTCUT_HELP_LABEL_KEYS: Record<string, string> = {
  ...
  "model-slot": "composer.loadout.shortcuts.modelSlot",
  "cycle-effort": "composer.loadout.shortcuts.cycleEffort",
  "toggle-fast": "composer.loadout.shortcuts.toggleFast",
...
const SHORTCUT_BINDINGS: readonly ShortcutBinding[] = [
  ...
  // --- Model loadout ---
  // Listed ahead of the Files target: the fast toggle reuses its Cmd/Ctrl+Shift+E while the
  // message input is focused, and the first matching binding wins.
  {
    id: "message-input-model-slot-cmd-ctrl-digit-mac",
    action: "message-input.model-slot",
    combo: "Cmd+Ctrl+Digit",
    when: { mac: true, commandCenter: false },
    payload: { type: "index" },
    help: {
      id: "model-slot",
      section: "agent-input",
      label: "Switch to model 1-5",
      defaultDisplayKeys: ["ctrl", "mod", "1-5"],
    },
  },
  {
    id: "message-input-model-slot-ctrl-alt-digit-non-mac",
    action: "message-input.model-slot",
    ...
    help: {
      ...
      section: "agent-input",
      label: "Switch to model 1-5",
      defaultDisplayKeys: ["ctrl", "alt", "1-5"],
    },
  },
  {
    id: "message-input-effort-cycle-cmd-shift-slash-mac",
    action: "message-input.action",
    combo: "Cmd+Shift+/",
    repeat: false,
    when: { mac: true, commandCenter: false },
    payload: { type: "message-input", kind: "effort-cycle" },
    help: {
      id: "cycle-effort",
      section: "agent-input",
      label: "Cycle effort",
  ...
  {
    id: "message-input-effort-cycle-ctrl-shift-slash-non-mac",
    action: "message-input.action",
    combo: "Ctrl+Shift+/",
    repeat: false,
    when: { mac: false, commandCenter: false, terminal: false },
  ...
  {
    id: "message-input-fast-toggle-cmd-shift-e-mac",
    action: "message-input.action",
    combo: "Cmd+Shift+E",
    repeat: false,
    when: { mac: true, commandCenter: false, focusScope: "message-input" },
    payload: { type: "message-input", kind: "fast-toggle" },
    help: {
      id: "toggle-fast",
      section: "agent-input",
  ...
  {
    id: "message-input-fast-toggle-ctrl-shift-e-non-mac",
    action: "message-input.action",
    combo: "Ctrl+Shift+E",
    repeat: false,
